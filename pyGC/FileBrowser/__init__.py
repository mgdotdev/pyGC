# NOTE:
# Verbatum copy of the kivy-garden fileBrowser, as the pip-installation method
# was nonfunctional at the time of pyGC's release. The author's of the pyGC
# module take no credit for this build. Released by @Matham under MIT license.
#
